"""
Django settings for trafik_tahmin project.
"""
...
ROOT_URLCONF = 'trafik_tahmin.urls'
...
WSGI_APPLICATION = 'trafik_tahmin.wsgi.application'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'trafik_app/static/'),
]
